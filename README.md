...
모든 신규 책임 모듈은 주석과 빈 줄을 포함해 1,000줄 이하로 제한하고, 책임이 둘로 갈리면 줄 수와 무관하게 분리합니다. 공개 호환성과 실행 조립을 유지하는 composition root도 현재 963줄이며 새 비즈니스 로직과 순증가를 허용하지 않습니다. 이는 극단적 경량화 주장이 아니라 god-file 재발을 막는 유지보수 계약입니다.
